...
<body>
    ...
    <h2>Hitung Magic Wheel Mobile Legends</h2>
    <div class="container">
        <label for="volume">Point Magic Wheel Anda Saat ini :</label>
        <span id="volumeValue">100</span>
        <br>
        <!-- <input type="range" id="volume" name="volume" min="0" max="200" value="100" oninput="updateVolume()"> -->
        <input type="range" id="volume" min="0" max="200" value="100" class="slider" id="myRange"
            oninput="updateVolume(); updateVolume2();">
        <br>
        <p style="font-size: 16px; color: #081b30;">
            Kamu membutuhkan maksimal <span id="maxDiamond"
                style="font-size: 20px; color: #1b78e0; font-weight: bold;">5400</span>
        ...
        <p style="font-size: 16px; color: #081b30;">
            Kamu membutuhkan maksimal <span id="maxDiamond2"
                style="font-size: 20px; color: #1b78e0; font-weight: bold;">4320</span>
            <span class="diamond-icon"> <i class="fa fa-diamond" style="color: #1b78e0;"></i></span> untuk mendapatkan
            Skin Legend
            <span style="color: red; font-weight: bold">(Harga Diskon 20%)</span>
        </p>
    ...
    <script>
        ...
        function updateVolume() {
            ...
            if (initialValue === 200) {
                ...
                var diamondsToReachMultipleOf5 = (nearestMultipleOf5 + 5 - initialValue) * 60;
                var diamondsAfterReachingMultipleOf5 = (200 - (nearestMultipleOf5 + 5)) / 5 * 270;
        ...
        function updateVolume2() {
            ...
            if (initialValue === 200) {
                ...
                // Calculate requiredDiamond to add 5 points continuously until the nearest multiple of 5 below 200
                requiredDiamond = (200 - initialValue) / 5 * 216;
            } else {
                // Calculate requiredDiamond to add 5 points repeatedly until it reaches the nearest multiple of 5 and then continue adding 5 points until it reaches 200
                var nearestMultipleOf5 = Math.floor(initialValue / 5) * 5;
                var diamondsToReachMultipleOf5 = (nearestMultipleOf5 + 5 - initialValue) * 48;
                var diamondsAfterReachingMultipleOf5 = (200 - (nearestMultipleOf5 + 5)) / 5 * 216;
                requiredDiamond = diamondsToReachMultipleOf5 + diamondsAfterReachingMultipleOf5;
            }
        ...
        function getSliderPercentage() {
            var volumeInput = document.getElementById("volume");
            var percentage = (volumeInput.value - volumeInput.min) / (volumeInput.max - volumeInput.min - 15);
            return percentage;
        }
